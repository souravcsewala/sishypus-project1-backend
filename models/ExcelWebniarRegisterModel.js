...
const ExcelWebniarRegisterSchema = new Schema({
  ...
  phone: {
    ...
    minLength: [11, "Phone number must include country code and be at least 11 digits"],
...
const ExcelWebniarRegisterModel = new model('excelwebniarregister',ExcelWebniarRegisterSchema);
