...
const Router = express.Router();  
 ...
 //!14. create german course , excel, others
  Router.route("/admin/create/Course").post(isAuthCheak,isAdminCheak("admin"),CreateCourse)

  //!15. update german course ,excel, others
  Router.route("/admin/course/update/:id").put(isAuthCheak,isAdminCheak("admin"),UpdateCourse)

  //!16. delete german course , excel course
  Router.route("/admin/course/remove/:id").delete(isAuthCheak,isAdminCheak("admin"),DeleteCourse)
...
//!44.  course details 
Router.route("/api/CourseDetails/:Id").get(isAuthCheak,isAdminCheak("admin"),GetCourseDetails)

//!46. card details 
Router.route("/api/white-card/details/:Id").get(isAuthCheak,isAdminCheak("admin"),getCarDdetails)

//!47. get student --admin 
Router.route("/admin/get-enrolled-students").get(isAuthCheak,isAdminCheak("admin"),fetchStudents)

//!48. give access to dashboard for students --admin
Router.route("/admin/students/:id/DashboardAccess").patch(isAuthCheak,isAdminCheak("admin"),toggleStudentAccess)

//! get order list -- admin 
Router.route("/admin/get-order-list").get(isAuthCheak,isAdminCheak("admin"),fetchOrders)
